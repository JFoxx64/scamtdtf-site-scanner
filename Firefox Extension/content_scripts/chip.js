...
function fillInfoChip(){
  ...
  if(infochip && warningkey){
    ...
    articlelink.textContent = 'Click To Learn More';
    infochip.appendChild(articlelink);
  }
}
...
function updateSiteChipStatus(){
  ...
  if(sitechip && iconcontainer){
      ...
      if(laststatus == "nopermission"){
        ...
        if(sitechip){
            statusdiv.innerHTML = "<b style='font-size: 14px'>We don't have permission!</b><div style = 'font-size: 10px;'>What does this mean?</div><div>You need to agree for us to use the URLs to the sites you visit in order for us to scan them.  If you recently gave permission, try refreshing the page.</div>";
        }
    }
        ...
        if(statusdiv){
            statusdiv.innerHTML = "<b style='font-size: 14px'>No Issues Found</b><div style = 'font-size: 10px;'>What does this mean?</div><div>The STDTF Deep Scanner didn't find any indicators that this site is dangerous; However: The Deep Scanner is NOT perfect.  Always be careful.</div>";
        }
      }
        ...
        if(statusdiv){
          ...
          title.textContent = warningkey.title;
          statusdiv.appendChild(title);

          let tagline = document.createElement("div");
          tagline.style = "font-size: 10px;"
          tagline.textContent = "What does this mean?";
          statusdiv.appendChild(tagline);

          let description = document.createElement("div");
          description.textContent = warningkey.description;
          statusdiv.appendChild(description);
        }
      }
        ...
        if(statusdiv){
            statusdiv.innerHTML = "<b style='font-size: 14px'>We Ran Into A Snag</b><div style = 'font-size: 10px;'>What does this mean?</div><div>We had some issues reviewing this site, please be careful! If the site looks suspicious, report it below.</div>";
        }
      }
      else{
        icon.style = "width: 54px; height: 54px; margin-top: 50px; padding: unset; box-sizing: unset;"
        icon.innerHTML = '<div class="stdtf-flake stdtf-flake-four"></div>'
...
function fillShareChip(){
  ...
  if(sharechip){
      ...
      facebookbutton.innerHTML = '<svg style= "vertical-align: middle; height: 40px; width: 40px;" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 14222 14222"><circle cx="7111" cy="7112" r="7111" fill="#1977f3"/><path d="M9879 9168l315-2056H8222V5778c0-562 275-1111 1159-1111h897V2917s-814-139-1592-139c-1624 0-2686 984-2686 2767v1567H4194v2056h1806v4969c362 57 733 86 1111 86s749-30 1111-86V9168z" fill="#fff"/></svg>';
      ...
      youtubebutton.innerHTML = '<svg style="vertical-align: middle; height: 40px; width: 40px;" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 40 40"><path fill="#FF0000" d="M20,0.5L20,0.5c10.8,0,19.5,8.7,19.5,19.5l0,0c0,10.8-8.7,19.5-19.5,19.5l0,0C9.2,39.5,0.5,30.8,0.5,20l0,0 C0.5,9.2,9.2,0.5,20,0.5z"/> <path fill="#FFFFFF" d="M20,10.6c0,0-8.4,0-10.5,0.5c-1.1,0.3-2.1,1.2-2.4,2.4C6.5,15.6,6.5,20,6.5,20s0,4.4,0.5,6.5 c0.3,1.1,1.2,2.1,2.4,2.4c2.1,0.6,10.5,0.6,10.5,0.6s8.4,0,10.6-0.5c1.1-0.3,2.1-1.2,2.4-2.4c0.6-2.1,0.6-6.5,0.6-6.5s0-4.4-0.6-6.5 c-0.3-1.1-1.2-2.1-2.4-2.4C28.4,10.6,20,10.6,20,10.6z M17.3,16l7,4l-7,4V16L17.3,16z"/></svg>';
...
function fillNewsChip(){
  ...
  if(newschip){
      ...
      loadingdiv.innerHTML = "<b style='font-size: 16px'>Loading Article...</b><div>Getting Latest Article from Scam Takedown Task Force</div>";
